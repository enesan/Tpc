...
export interface ICardClient {
    ...
    upload(file: FileParameter | null | undefined): Observable<FileResponse>;
}
...
export class CardClient implements ICardClient {
    ...
    upload(file: FileParameter | null | undefined): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/Card/upload";
        url_ = url_.replace(/[?&]$/, "");
...
export abstract class BaseEntityOfCardFile implements IBaseEntityOfCardFile {
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"];
            this.file = _data["file"] ? CardFile.fromJS(_data["file"]) : <any>undefined;
        }
    }
...
export class Sector implements ISector {
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"];
            this.file = _data["file"] ? SectorFile.fromJS(_data["file"]) : <any>undefined;
        }
    }
